...
<div class="login-box">
        <div class="logo">
            ...
            <div class="p-t-10 helptext">
			<div class="clearfix">
            <span class="pull-left"><a href="https://www.orangescrum.com/how-it-works" target="_blank"><small>How it Works?</small></a></span>
			<span class="pull-right"><a href="https://www.orangescrum.com/help" target="_blank"><small>Help!</small></a></span>
			</div>
			</div>
                ...
                <form id="sign_in" method="POST">
                    ...
                    <div class="row m-t-15 m-b--20">
                        ...
                        <div class="col-xs-6 align-right">
                            <a href="<?php echo HTTP_ROOT; ?>users/forgotpassword" class="forgot_pwd">Forgot Password?</a>
                        </div>
                    </div>
                </form>
            </div>
